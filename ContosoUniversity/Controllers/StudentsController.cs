...
namespace ContosoUniversity.Controllers
{
    public class StudentsController : Controller
    {
        ...
        // GET: Students
        public async Task<IActionResult> Index(string sortOrder, string currentFiler, string searchString, int? page)
        {
            ...
            if (!string.IsNullOrEmpty(searchString))
                students =  from s in students 
                            where s.LastName.Contains(searchString) || s.FirstMidName.Contains(searchString)
                            select s;
